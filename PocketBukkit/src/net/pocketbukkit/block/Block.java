...
public class Block {
	...
	public static long meta;
	public static int name;
	public static int breakTime;
	public static int hardness;
	public static boolean isActivable = false;
	public static boolean breakable = true;
	public static boolean isFlowable = false;
	public static boolean isSolid = true;
	public static boolean isTransparent = false;
	public static boolean isReplaceable = false;
	public static boolean isPlaceable = true;
	public static boolean hasPhysics = false;
	public static boolean isLiquid = false;
	public static boolean isFullBlock = true;
	public static int x = 0;
	public static int y = 0;
	public static int z = 0;
	public static double frictionFactor = 0.6;
